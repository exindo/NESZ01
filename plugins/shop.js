...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
	const _fishingrod = global.DATABASE._data.users[m.sender].fishingrod
	const fishingrod = (_fishingrod == 0 ? 25000 : '') 
	const _pickaxe = global.DATABASE._data.users[m.sender].pickaxe
	const pickaxe = (_pickaxe == 0 ? 20000 : '' || _pickaxe == 1 ? 49999 : '' || _pickaxe == 2 ? 99999 : '' || _pickaxe == 3 ? 149999 : '' || _pickaxe == 4 ? 299999 : '' || _pickaxe == 5 ? 400000 : '' || _pickaxe == 6 ? 800000 : '')
    const _armor = global.DATABASE._data.users[m.sender].armor
    const armor = (_armor == 0 ? 20000 : '' || _armor == 1 ? 49999 : '' || _armor == 2 ? 99999 : '' || _armor == 3 ? 149999 : '' || _armor == 4 ? 299999 : '' || _armor == 5 ? 400000 : '' || _armor == 6 ? 800000 : '') 
            ...
            case 'buy':
                switch (_type) {
                    ...
                    case 'sampah':
                        ...
                        break
                    case 'armor':
                            if (global.DATABASE._data.users[m.sender].armor == 6) return conn.reply(m.chat, 'Armormu sudah *Level Max*', m)
                        ...
                        break
                     case 'pickaxe':
                             if (global.DATABASE._data.users[m.sender].pickaxe == 6) return conn.reply(m.chat, 'Pickaxemu Sudah *Level Max*', m) 
                        ...
                        break
                      case 'fishingrod':
                              if (global.DATABASE._data.users[m.sender].pickaxe == 6) return conn.reply(m.chat, 'Fishingrod Sudah *Level Max*', m)
                              if (global.DATABASE._data.users[m.sender].money > fishingrod) {
                              	global.DATABASE._data.users[m.sender].fishingrod += 1
                                  global.DATABASE._data.users[m.sender].money -= fishingrod * 1
                                  conn.reply(m.chat, `COMMING SOON` , m) 
