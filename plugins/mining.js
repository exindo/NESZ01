...
let handler = async (m, { conn, usedPrefix, DevMode }) => { 
    try { 
        ...
        if (global.DATABASE._data.users[m.sender].healt > 79) {
            if (new Date - global.DATABASE._data.users[m.sender].lastmining > 300000) {
            ...
            let str = `
Nyawa mu berkurang -${healt * 1} karena Kamu telah mining sampai ${pickRandom(['Bedrock', 'Void', 'Lava', 'Amerika', 'Iraq', 'Arab', 'Pakistan', 'German', 'Finlandia', 'Ke bawa dunia mimpi', 'Ujung dunia', 'Mars', 'Bulan', 'Pluto', 'Matahari', 'Hatinya dia', '...'])} dan mendapatkan
*exp:* ${exp} 
*uang:* ${uang}
