...
Health: *${healt}❤*
*Peralatan*
Fishingrod: *${fishingrod == 0 ? 'Tidak Punya': '' || fishingrod == 1 ? 'Fishingrod Kayu' : ''}*
Pickaxe: *${pickaxe == 0 ? 'Tidak Punya': '' || pickaxe  == 1 ?'Wooden Pickaxe' : '' || pickaxe  == 2 ? 'Iron Pickaxe' : '' || pickaxe == 3 ? 'Gold Pickaxe' : '' || pickaxe == 4 ? 'Diamond Pickaxe' : '' || pickaxe == 5 ? 'Netherite Pickaxe' : '' || pickaxe == 6 ? 'PurPur Pickaxe' : ''}*
Armor: *${armor == 0 ? 'Tidak Punya' : '' || armor == 1 ? 'Leather Armor' : '' || armor == 2 ? 'Iron Armor' : '' || armor == 3 ? 'Gold Armor' : '' || armor == 4 ? 'Diamond Armor' : '' || armor == 5 ? 'Netherite Armor' : '' || armor == 6 ? 'PurPur Armor' : ''}*\n
Money: *${money}💰*
Level: *${level}*
Exp: *${exp}*\n
*Inventory*
